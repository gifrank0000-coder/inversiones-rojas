...
try {
    ...
    $stmtUpd = $pdo->prepare("UPDATE reservas SET estado_reserva = 'CANCELADA', vendedor_id = :vendedor, updated_at = now() WHERE id = :id");
    ...
    error_log('cancel_reserva error: ' . $e->getMessage());
