...
register_shutdown_function(function() {
    $err = error_get_last();
    if ($err !== null) {
        // Solo manejar errores fatales que interrumpen el script (no warnings/notices)
...
// Conectar a la base de datos (necesario para validaciones y operaciones)
$db = new Database();
...
try {
    ...
    $productos_ids = array_filter($productos_ids, function($v) { return $v > 0; });
