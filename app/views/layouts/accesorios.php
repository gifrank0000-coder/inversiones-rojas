...
<body>
                    ...
                    <div class="product-card" 
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-actions">
                                ...
                                <button class="btn-cart" onclick="agregarAlCarrito(<?php echo $accesorio['id']; ?>)">
    ...
    <script>
                    ...
                    <div class="product-card" data-categoria="${accesorio.categoria || ''}" data-precio="${accesorio.precio_venta}">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-actions">
                                ...
                                <button class="btn-cart" onclick="agregarAlCarrito(${accesorio.id})">
                                    <i class="fas fa-cart-plus"></i>
                                </button>
                            </div>
                        </div>
        ...
        function limpiarFiltros() {
            ...
            if (contador) {
                contador.textContent = totalProductos + ' accesorios';
            }
        ...
        function mostrarPagina(pagina) {
            ...
            if (contadorElement) {
                contadorElement.textContent = `${totalProductosVisibles} de ${totalProductos} accesorios`;
            }
        }
