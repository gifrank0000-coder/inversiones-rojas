...
<body>
    ...
    <script>
        ...
        // ── FUNCIÓN: Agregar item al drawer del carrito ──
            ...
            btn.addEventListener('click', function (e) {
                ...
                .then(function (data) {
                    if (data.success || data.ok) {
                        ...
                        // Actualizar contador del carrito en el header - asegurar que el elemento SIEMPRE se actualice
                        ...
                        // Actualizar drawer del carrito si la función existe
                        ...
                        if (typeof addItemToDrawer === 'function') {
                            addItemToDrawer(parseInt(productId), productName, 1, productPrice, productImage);
                            
                            // Animar el drawer si existe (scroll suave al carrito)
